package self.miles.common.idempotent.aspectj;
...
import self.miles.common.core.constants.RedisPrefixConstants;
...
public class RepeatSubmitAspect {
    ...
    public void doBefore(JoinPoint point, RepeatSubmit repeatSubmit) throws Throwable {
        ...
        // 唯一标识（指定key + url + 消息头）
        String cacheRepeatKey = RedisPrefixConstants.REPEAT_SUBMIT_KEY + url + submitKey;
