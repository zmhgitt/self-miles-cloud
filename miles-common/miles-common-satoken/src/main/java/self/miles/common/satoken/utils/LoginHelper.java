package self.miles.common.satoken.utils;
...
import self.miles.common.core.constants.TenantConstants;
import self.miles.common.core.constants.UserConstants;
import self.miles.common.core.enums.UserType;
...
public class LoginHelper {
    ...
    public static void login(LoginUser loginUser, SaLoginModel model) {
        //获取当前请求的 [存储器] 对象，即请求上下文对象，提供 [一次请求范围内] 的上下文数据读写
