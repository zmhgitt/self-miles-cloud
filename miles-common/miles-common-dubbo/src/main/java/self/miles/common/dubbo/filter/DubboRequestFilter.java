package self.miles.common.dubbo.filter;
...
import self.miles.common.core.utils.SpringUtils;
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (result.hasException() && invoker.getInterface().equals(GenericService.class)) {
            ...
            if (properties.getLogLevel() == RequestLogEnum.INFO) {
                ...
                log.info("DUBBO - 服务响应: {},SpendTime=[{}ms],Response={}", baselog, elapsed, JSONObject.toJSONString(new Object[]{result.getValue()}));
            }
        }
        return result;
    }
