...
import self.miles.gen.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable) {
        ...
        genTable.setParentMenuId(GenConfig.getParentMenuId());
        genTable.setAbsolutePath(GenConfig.getAbsolutePath());
    }
    ...
    public static String replaceText(String text) {
        return RegExUtils.replaceAll(text, "(?:表|Miles)", "");
    }
